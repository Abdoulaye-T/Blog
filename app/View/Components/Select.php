...
class Select extends Component
{
     ...
     * Collection va contenir la liste des elements (tags, category) que l'on souhaite faire apparaitre
     * mixed pour dire qu'une propriete peut-etre de multiple type different
     */
