    ...
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <header class="flex justify-between items-center space-x-5 text-slate-900">
            ...
            <nav x-data="{ open: false }" x-cloak class="relative">
                ...
                <li><a href="{{ route('admin.posts.index') }}" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">Gestion des postes</a></li>
        ...
        <main class="mt-10 md:mt-12 lg:mt-16">
            ...
            {{-- La variable $slot va contenir tout le contenu qui sera mit dans mon composant Layout --}}
           {{ $slot }}  
